...
// http://jsfiddle.net/RationalGeek/1f3yc5fh/
// Create the jQuery plugin
function init_CommaTextBox() {
    $.fn.commaTextbox = function (comma = 0) {
        var applyFormatting = function (that) {
            ...
            var decimalRegex = /(\d{0,12})/g;
            if (comma == 1) {
                decimalRegex = /(\d{0,12})(\.(\d{1,2})?)?/g
            }
        ...
        //this.parent().prepend("<div class='commaTextbox-currency'>Rp</div>");
